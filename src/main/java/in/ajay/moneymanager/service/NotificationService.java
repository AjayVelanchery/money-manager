...
import in.ajay.moneymanager.repository.ProfileRepository;
...
public class NotificationService {
    ...
    /**
     * Send reminder every night at 10 PM IST
     */
    ...
    /**
     * Send daily expense summary every night at 11 PM IST
//     */
        ...
        for (ProfileEntity profile : profiles) {
            ...
            if (!todayExpenses.isEmpty()) {
                ...
                table.append("<tr style='background-color:#f2f2f2;'>")
                        ...
                        .append("<th style='border:1px solid #ddd;padding:8px;'>Category ID</th>")
                        .append("</tr>");
                ...
                String body = "Hi " + profile.getFullName() + ",<br><br>" +
                        "Here’s your summary of today’s expenses:<br><br>" +
                        table +
                        "<br><br>Keep tracking your finances regularly!<br><br>Best regards,<br>Money Manager Team";
